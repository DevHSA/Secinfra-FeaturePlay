...
def mainfunc():
	...
	print("The program extracts epoch level features for FlowRadar: ");
	...
	parser.add_argument('--type', metavar='<attack or benign scenario>', help='is it attack or benign; 1 = atk, 2 = ben', required=True)
	...
	atkben = int(args.type) #is it attack or benign; 1 = atk, 2 = ben'
	...
	#Inserting the flows from the pcap and creating a groundd truth. This is the control setup
